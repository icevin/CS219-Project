...
client_model = YolosForObjectDetection.from_pretrained("hustvl/yolos-tiny").to(
...
def pred(image):
    ...
    r = requests.post(
        ...
        headers={
            ...
            "Content-Length": f"{buff.getbuffer().nbytes}",
        },
    )
    ...
    for score, label, box in zip(
        ...
        cv2.rectangle(
            a_img, start_point, end_point, (0, 0, 255), thickness=1, lineType=cv2.LINE_8
        )
        cv2.putText(
            a_img,
